...
public class ExecuteServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)  throws ServletException, IOException {
        ...
        try {
            ...
            String[] lister=new String[]{"Nearest Mean Classifier","K Nearest Neigbors","MultiLayer Perceptron","AutoEncoders","Linear SVM","Self Optimizing SVM","Random Forest","Random Tree"};
            String modelName;
            switch(mType)
            {
